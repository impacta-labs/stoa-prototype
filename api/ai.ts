    ...
    if (action === 'generateDecision') {
      ...
      const message = await client.messages.create({
        ...
        messages: [
          {
            role: 'user',
            content: `Eres un asesor estratégico senior y CFO interno de ${orgName}.\n\nLa organización está evaluando esta iniciativa:\nTítulo: "${titulo}"\nTipo: ${tipo}\n\nGenera en español:\n1. preguntaEstrategica: pregunta estratégica precisa (1 frase, termina en "?") que enmarca esto como una decisión, no una tarea. Qué está en juego y qué se pierde si no se actúa o se actúa mal.\n2. hipotesis: hipótesis de impacto (2-3 frases) con cambio medible y estimación económica concreta en euros. Sé específica para este contexto y tipo de iniciativa.\n3. plLever: palanca de cuenta de explotación CON cuantificación en euros. Formato corto: descripción del efecto + estimación €M. Ejemplo: "Reducción coste operativo 0.8–1.2M€/año · liberación de capacidad equipo". Obligatorio incluir cifra en €M.\n4. indicadoresLideres: array de 3 indicadores tempranos concretos y medibles\n5. riesgoNoActuar: coste de oportunidad o riesgo de no actuar (2-3 frases, con consecuencias concretas y cifra en €)\n6. casoInversion: caso de negocio estructurado con campos NUMÉRICOS en euros:\n   - costeProblemActual: número entero en € por año (coste de NO actuar, ej: 450000)\n   - inversionRequerida: número entero en € total (capex + opex primer año, ej: 120000)\n   - retornoEsperado: número entero en € por año (ahorro o ingreso incremental, ej: 380000)\n   - confianza: "Bajo", "Medio", o "Alto" (tu nivel de certeza sobre las estimaciones)\n   Sé conservador pero específico. Usa órdenes de magnitud realistas para el tipo de iniciativa.\n\nResponde SOLO con JSON válido sin markdown:\n{"preguntaEstrategica":"...","hipotesis":"...","plLever":"...","indicadoresLideres":["...","...","..."],"riesgoNoActuar":"...","casoInversion":{"costeProblemActual":0,"inversionRequerida":0,"retornoEsperado":0,"confianza":"Medio"}}`,
          },
        ],
      })
